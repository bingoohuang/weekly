...
1. 查明一下来源，[chronograf中的魔术数字125000](https://github.com/influxdata/chronograf/search?q=125000&unscoped_q=125000)
...
1. 谷歌随意一下 [125000的解释](https://www.quora.com/Is-an-Internet-speed-of-100Mbps-considered-fast)
...
1. 然后总结一下
  ...
  - chronograf中除以125000，实际上是将网卡速度的单位调整到Mb/s，正如name中`System – Network Mb/s`和label的`Mb/s`中说明的一样。
	- 按照单位Mb/s，如果千兆网卡的网速如果达到了125，那实际上就是网卡已经被流量打满了。
